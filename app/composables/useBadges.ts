...
export const BADGE_CATALOG: BadgeDef[] = [
  { code: 'first-record',      name: '첫 기록',         description: '회고 1개 저장하기',           unlockText: '회고를 1개 저장하면 받을 수 있어요.', conditionType: 'FIRST_RETRO' },
  { code: 'record-10',         name: '10회 기록',        description: '회고 10개 저장하기',          unlockText: '회고를 10개 저장하면 받을 수 있어요.', countable: true, goal: 10 },
  { code: 'record-30',         name: '30회 기록',        description: '회고 30개 저장하기',          unlockText: '회고를 30개 저장하면 받을 수 있어요.', countable: true, goal: 30, conditionType: 'TOTAL_30' },
  { code: 'project-collector', name: '프로젝트 컬렉터',   description: '프로젝트 3개 만들기',          unlockText: '프로젝트를 3개 만들면 받을 수 있어요.' },
  { code: 'project-picker',    name: '프로젝트 피커',     description: '회고 5개를 프로젝트에 담기',    unlockText: '회고 5개를 프로젝트에 담으면 받을 수 있어요.' },
  { code: 'project-digger',    name: '프로젝트 디기너',   description: '한 프로젝트에 회고 3개 담기',   unlockText: '한 프로젝트에 회고 3개를 담으면 받을 수 있어요.' },
  { code: 'routine-first',     name: '루틴의 첫 걸음',    description: '한 주에 회고 3개 쓰기',        unlockText: '한 주에 회고 3개를 쓰면 받을 수 있어요.', conditionType: 'WEEKLY_3_FIRST' },
  { code: 'routine-power',     name: '루틴의 힘',         description: '3주 동안 매주 회고 3개 쓰기',  unlockText: '3주 동안 매주 회고 3개를 쓰면 받을 수 있어요.', conditionType: 'WEEKLY_3_THREE_WEEKS' },
  { code: 'routine-streak',    name: '루틴의 지속',       description: '4주 연속 회고 남기기',         unlockText: '4주 연속 회고를 남기면 받을 수 있어요.' },
  { code: 'didit-lover',       name: '디딧 러버',         description: '1주 동안 매일 접속하기',       unlockText: '1주 동안 매일 접속하면 받을 수 있어요.' },
]
